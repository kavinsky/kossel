...
#define CUSTOM_MENDEL_NAME "ErlenCalibration"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 210.0 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 161.85 //156.4 // mm //158
...
#define TOWER_A_ENDSTOP_ADJ -3.51 // Front Left Tower
#define TOWER_B_ENDSTOP_ADJ -3.51 // Front Right Tower
#define TOWER_C_ENDSTOP_ADJ -3.97 // Rear Tower
...
#define Z_PROBE_OFFSET {22, -11, -4.3, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
#define MANUAL_Z_HOME_POS 218.5  // For delta: Distance between nozzle and print surface after homing.
