...
#define STRING_CONFIG_H_AUTHOR "(Kavinsky, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Erlenmeyer"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "e0dc6bd3-2a3b-44f7-9da5-ea70aa821bff"
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  #define  DEFAULT_bedKp 81.00
  #define  DEFAULT_bedKi 2.25
  #define  DEFAULT_bedKd 728.55
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 210.8 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 161.85 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 25.98 // mm
  ...
  #define DELTA_ESTOP_ADJ_A 0.0
  #define DELTA_ESTOP_ADJ_B 0.0
  #define DELTA_ESTOP_ADJ_C 0.0

  #define DELTA_TOWER_ADJ_A 0.0
  #define DELTA_TOWER_ADJ_B 0.0
  #define DELTA_TOWER_ADJ_C 0.0
#endif
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -4.3  // Z probe to nozzle Z offset: -below (always!)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 219.53 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_ZJERK                 10    // (mm/sec) Must be same as XY for delta
